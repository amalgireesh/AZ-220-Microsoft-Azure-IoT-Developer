...
#### Task 1: Get the Device Connection String //Automation , Will O/P the IoT Hub Device Connection String
#### Task 2: Explore the application //Automation
...
+ DEVICE 01 <Register> <Activate> <Unregister> <Send Telemetry> <Stop Telemetry> <Anomaly>
