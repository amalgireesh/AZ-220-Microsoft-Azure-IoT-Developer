...
### Exercise 1: Check data in blob storage using Storage Explorer
...
#### Task 1: Add a New Output to the Job
...
### Task 2: Check data in blob storage (Storage Explorer)
...
1. On your Resource group tile, click **IoT-DepolymentID**.
...
1. Notice that the spikes in **temperature** of the **Device01** correlate with the temperature spikes of either the **Device02** or the **Device03**.

    This gives you an indication that the Device01 is being transported by Truck or Airplane at those times.
