...
2. If you got a prompt for creating storage account, click on **Show advanced settings** and select existing Resource Group as **AzureMigrateRG** and enter **iotstorage{deploymentid}** for storage account name and Enter **blob** for File Share.

   >Note: - You can get the **deployment-id** details from your environment details page.

   ![](media/storageiot.png)
