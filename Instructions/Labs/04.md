...
2. If you got a prompt for creating storage account, click on **Show advanced settings** and select existing Resource Group as **AzureMigrateRG** and enter **shellstorage{deploymentid}** for storage account name and Enter **filestorage{deploymentid}** for File Share.
