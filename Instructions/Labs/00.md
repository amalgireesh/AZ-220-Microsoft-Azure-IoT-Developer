...
* Create an Azure Dashboard and Explore already created Azure resources in the Resource Group
...
#### Task 2: Explore existing resources in the Resource Group and add a Resource Group tile to your Dashboard
