...
### Exercise 2: Explore Resource Group
...
* Explore through the preprovisioned reources in the resource group **iot-{deployment id}**

#### Task 1: Explore existing resources in the Resource Group and add a Resource Group tile to your Dashboard
